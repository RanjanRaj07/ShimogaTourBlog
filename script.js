function getCurrentSlideIndex (){
  ...
  switch(activeSlideIndex){
    ...
    case 2:
      ...
      break
    case 3:
      data.innerHTML = '<div class="data-class" data-aos="fade-up"><h2>Sri kshethra Sridharashrama - Varadapura</h2><p>The Shrine is place where Saint Shri Shridhara Swami also referred to as "Bhagwan Sadguru Shri Shridhar Swami Maharaj" who lived here and spent his last few years of his life preaching the Dharma and some of his principles to his disciples and led the foundation for this Shrine.This Shrine consists of Samadhi, Gynan Mandir, Dharma Sthamba, Goshala, Shridhar Teertha. <br>Vardhapura also known as Varadahalli is a small village surrounded by picturesque location, near Sagara City, Karnataka.</p></div>'
      break
    case 4:
    ...
    case 6:
      ...
      break
    case 7:
      data.innerHTML = '<div class="data-class" data-aos="fade-up"><h2>Museum Malgudi</h2><p>Malgudi days the famed TV serial based on RK Narayan\'s book of same title was filmed in these environs. The Malgudi days serials got fame for the stories of a youg boy swami and his intresting incidents. The director and master mind of the show was the legend of kannada film industry <strong>Mr.Shankar nag</strong>.  <br>Arasalu hosted the railway scenes that appeared in various episodes.Arasalu railway station or Museum Malgudi is about 32 kms from Shivamogga city. You have to turn left at Ayanur (about 16kms) while heading towards Sagara on BH Road.</p></div>'
      break
  }
}
